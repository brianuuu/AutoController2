...
void StarterReset::OnFrameCaptureMatched(bool matched)
{
    ...
    case State::GetStarter:
    {
        if (matched)
        {
            ...
            m_moduleHolder->AddRunCommand("(A|50,None|50)2,None|" + QString::number(m_advanceFrame->value() * 20 + m_confirmDelay->value()) + ",B|Spam|15000");
    ...
    case State::ConfirmStarter:
    {
        ...
        else if (m_dialogCount == 2 && !matched && m_elapsedTimer.elapsed() > 300)
        {
            ...
            m_moduleHolder->AddRunCommand("FRLG_StarterCheck", 0);
        }
        break;
    }
