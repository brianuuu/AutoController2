...
void CameraChecker::OnFrameCaptureMatched(bool matched)
{
    ...
    case State::DetectTheme:
    {
        ...
        {
            PrintLog("Unable to determine Nintendo Switch theme from color " + m_color.name() + ", color detection maybe inaccurate. (Is HDR option turned off for Nintendo Switch 2?)", LOG_Warning);
        }
